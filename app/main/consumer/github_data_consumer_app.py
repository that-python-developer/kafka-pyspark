...
from data_processor import GithubDataProcessor
...
def start():
    ...
    df_clean = get_raw_df(
        spark,
        GithubDataProcessor().GITHUB_DATA_USER_SCHEMA,
        GithubDataProcessor().GITHUB_DATA_USER_ALIAS
    )

    GithubDataProcessor().get_type_by_counts(df_clean)
